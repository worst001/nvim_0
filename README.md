...
<!-- TOC -->
* [基本信息](#基本信息)
  - [初始化的时候分了5个模块在init 分别为](#初始化的时候分了5个模块在init%20分别为)
  - [插件包分为Plug包 自定义包 Lua包](#插件包分为Plug包%20自定义包%20Lua包)
  - [基本配置与按键](#基本配置与按键)
  - [如何安装](#如何安装)
  - [需要注意的](#需要注意的)
* [目录结构](#目录结构)
...
`Neovim` 发展的很快，2022年年底左右 `lua plugin` 已经有人实现了自动化安装，不知不觉也已经有了 `go client` 了
